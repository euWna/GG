...
public class SubwayArea : MonoBehaviour
{
    ...
    private Dictionary<Collider, Bunker> BunkerDictionary;
    ...
    public void ResetFlowers()
    {
        ...
        // Reset each flower
        foreach (Flower flower in Bunkers)
        {
            flower.ResetFlower();
        }
    }
    ...
    {
        return BunkerDictionary[collider];
    }
    ...
    private void Awake()
    {
        ...
        BunkerDictionary = new Dictionary<Collider, Flower>();
        Bunkers = new List<Flower>();
    ...
    private void FindChildFlowers(Transform parent)
    {
        for (int i = 0; i < parent.childCount; i++)
        {
            ...
            else
            {
                ...
                if (flower != null)
                {
                    // Found a flower, add it to the Bunkers list
                    Bunkers.Add(flower);

                    // Add the nectar collider to the lookup dictionary
                    BunkerDictionary.Add(flower.nectarCollider, flower);
